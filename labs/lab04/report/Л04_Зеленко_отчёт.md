...
8. Скомпилируем исходный файл hello.asm в obj.o  и создадим файл листинга list.lst и проверяем, что файлы были созданы

![Создание файлов](image/8.png){ #fig:008 width=90% }

9. Передадим объектный файл на обработку компоновщику.

![Передача файла на компоновку](image/9.png){ #fig:009 width=90% }

10. Запустим на выполнение созданный исполняемый файл, находящийся в текущем каталоге.

![Запуск на выполнение созданный исполняемый файл](image/10.png){ #fig:010 width=90% }

11. Создадим копию файла hello.asm с именем lab4.asm

![Создание копии файла с именем lab4.asm](image/11.png){ #fig:011 width=90% }

12. откроем текстовый редактор

![открываем текстовый редактор](image/12.png){ #fig:012 width=90% }

13. Внесём изменения в текст программы в файле lab4.asm

![Внесение изменения в текст программы](image/13.png){ #fig:013 width=90% }
...
![Оттранслирование, компоновка, запуск](image/14.png){ #fig:014 width=90% }


15. Скопировала файлы hello.asm и lab4.asm в локальный репозиторий в ката-
...
![Копирование файлов в локальный репозиторий](image/15.png){ #fig:015 width=90% }
